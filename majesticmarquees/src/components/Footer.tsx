  ...
  return (
    <footer className="bg-[#f5f1e8] text-forest-800 pt-20 pb-10 border-t border-black">
      ...
      <div className="container-x py-8 flex items-center justify-center gap-8">
        ...
        <a
          href="https://g.page/r/CaQq7Kj2DzyQEAE/review"
          aria-label="Google Business"
          className="text-forest-800 hover:text-tan-500 transition-colors"
        >
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" aria-hidden="true">
            <path d="M4 9l1.2-3.2A2 2 0 0 1 7.07 4.5h9.86a2 2 0 0 1 1.87 1.3L20 9" />
            <path d="M4 9v10a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1V9" />
            <path d="M4 9h16" />
            <path d="M9 14h6" />
            <text x="12" y="8.2" fontSize="3.4" fontWeight="700" textAnchor="middle" fill="currentColor" stroke="none">G</text>
          </svg>
        </a>
      </div>

      <div className="container-x pt-2 pb-2 text-center text-xs uppercase tracking-[0.18em] text-forest-800/80">
        © {new Date().getFullYear()} {site.name} &amp; Tents. Superior Tents, Exceptional Service.
      </div>
    </footer>
  );
}
