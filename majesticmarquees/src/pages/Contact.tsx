...
export default function Contact() {
  return (
    <>
        ...
        <div className="absolute inset-0 flex items-center justify-center px-4">
          <div className="text-center max-w-4xl mx-auto text-cream-50">
            ...
            <div className="mt-10 flex flex-wrap justify-center gap-4">
              <Link to="/our-tents" className="btn-primary">Discover More</Link>
              <a
                href="#contact-form"
      ...
      <section className="section bg-[#d7c7a5] py-24 sm:py-32 lg:py-40">
        <div className="container-x text-center mb-12">
          ...
          <p className="mt-4 text-forest-700/80 italic font-display text-lg">
            Our clients appreciate our approach — discover their thoughts!
          </p>
        </div>
      ...
      <section className="section bg-[#f5f1e8]">
        <div className="container-x grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            ...
            <div className="mt-10">
              <Link to="#contact-form" className="btn-primary">Get in Touch</Link>
            </div>
          </div>
        </div>
      </section>
