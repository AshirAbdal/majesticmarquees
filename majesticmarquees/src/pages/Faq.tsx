        ...
        <div className="absolute inset-0 flex items-center justify-center px-4">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="mt-10 flex flex-wrap justify-center gap-4">
              <Link to="/contact-get-a-quote#contact-form" className="btn-primary">Get Started</Link>
              <Link to="/our-tents" className="btn-outline">Learn More</Link>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container-x">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            <div className="bg-[#eee9df] p-8 sm:p-10">
              ...
              <Link to="/contact-get-a-quote#contact-form" className="btn-primary mt-8 inline-block">Get in Touch</Link>
            </div>
