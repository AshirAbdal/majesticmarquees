      ...
      <section className="relative bg-black">
        ...
        <div className="absolute inset-0 flex items-center justify-center p-4 sm:p-8">
          <div className="bg-cream-50 px-6 sm:px-12 py-12 sm:py-16 text-center max-w-2xl w-full shadow-xl">
            ...
            <div className="mt-8">
              <Link href="/our-tents" className="btn-primary">Explore Our Tents</Link>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section bg-[#f5f1e8]">
        <div className="container-x grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            ...
            <div className="mt-8">
              <Link href="/contact-get-a-quote#contact-form" className="btn-primary">Get a Quote</Link>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-px bg-tan-500/50 max-w-[1280px] mx-auto">
            {cards.map((c) => (
              ...
              >
                ...
                <Link href={c.to} className="btn-outline mt-8 text-sm">
                  {c.cta}
                </Link>
              </article>
            ))}
      ...
      <section className="section bg-[#d7c8a5] pb-6 sm:pb-8">
        <div className="container-x">
          ...
          <div className="text-center mt-10">
            <Link href="/our-tents" className="btn-outline">View All Tents</Link>
          </div>
        </div>
      </section>
